                      ...
                      foreach($stmt as $row){
                        echo "
                          <tr>
                            ...
                            <td>".$row['quantity']."</td>
                            <td>
                              <button class='btn btn-success btn-sm edit btn-flat' data-id='".$row['cartid']."'><i class='fa fa-edit'></i> Редактирай количество</button>
                              <button class='btn btn-danger btn-sm delete btn-flat' data-id='".$row['cartid']."'><i class='fa fa-trash'></i> Изтрии</button>
                            </td>
                          </tr>
                        ";
                      }
